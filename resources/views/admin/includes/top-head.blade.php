    ...
    <link rel="icon" type="image/png" sizes="192x192" href="{{asset('public/assets/media/favicons/favicon-192x192.png')}}">
    ...
    <link rel="stylesheet" id="css-main" href="{{asset('public/assets/css/dashmix.min.css')}}">
